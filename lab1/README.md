...
Далее применем эрозия для нашего исходного изображения (после переведения в отенки серого и пороговой бинаризации) в сравнении с реализацией из библиотеки cv2
